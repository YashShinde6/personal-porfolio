...
const HeroSection = ({ darkMode }) => {
  return (
    <section id="hero" className="min-h-screen pt-20 relative overflow-hidden">
      ...
      >
        <div 
          className="w-full h-full bg-cover bg-center bg-no-repeat opacity-25 dark:opacity-15"
          style={{
            backgroundImage: `url('/yash_png.png')`,
            backgroundPosition: 'center right',
            filter: darkMode ? 'brightness(0.7) contrast(1.2)' : 'brightness(0.9) contrast(1.1)'
          }}
        />
        <div className={`absolute inset-0 ${
          darkMode 
            ? 'bg-gradient-to-l from-transparent via-gray-900/60 to-gray-900' 
            : 'bg-gradient-to-l from-transparent via-white/60 to-white'
        }`} />
      </motion.div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-20">
        <div className="flex items-center justify-center min-h-[80vh]">
          ...
          <motion.div
            ...
            className="text-center space-y-8 relative z-20 max-w-4xl"
          >
            {/* Profile Image - Small branding element */}
            <motion.div
              className="w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-500 to-purple-600 p-1 mx-auto mb-8"
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
            ...
            >
              <div className={`w-full h-full rounded-xl ${darkMode ? 'bg-gray-800' : 'bg-white'} flex items-center justify-center overflow-hidden`}>
                ...
                />
                <div className={`w-full h-full rounded-xl ${darkMode ? 'bg-gray-800' : 'bg-white'} flex items-center justify-center text-xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'} hidden`}>
                  Y
                </div>
              </div>
            </motion.div>
            ...
            <div>
              <motion.h1 
                className={`text-6xl md:text-8xl lg:text-9xl font-bold mb-6 ${darkMode ? 'text-white' : 'text-gray-900'} leading-tight`}
              ...
              <motion.div 
                className={`text-2xl md:text-3xl lg:text-4xl mb-8 ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            {/* Description */}
            <motion.p 
              className={`text-xl md:text-2xl leading-relaxed max-w-3xl mx-auto ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}
            ...
            >
              <motion.button
                ...
                className="px-10 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold text-lg rounded-xl hover:shadow-xl transition-all duration-300"
              ...
              <motion.a
                ...
                className={`px-10 py-4 border-2 ${
                  darkMode 
                    ? 'border-gray-600 text-gray-300 hover:border-gray-500 hover:bg-gray-800' 
                    : 'border-gray-400 text-gray-700 hover:border-gray-500 hover:bg-gray-50'
                } font-semibold text-lg rounded-xl transition-all duration-300 flex items-center gap-3`}
                whileHover={{ scale: 1.05, y: -3 }}
                whileTap={{ scale: 0.95 }}
              >
                <Download size={20} />
